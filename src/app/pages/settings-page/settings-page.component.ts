...
export const API_KEY_MESSAGE = `You'll need a <a href="https://developer.themoviedb.org/reference/intro/getting-started" target="_blank">TMDB API key</a> to search for most movies and TV shows. Without a key you can only search through a limited set of Marvel Cinematic Universe content.`;
